...
export const shippingInfoReducer = (state = { shippingInfo: {} }, action) => {
    switch (action.type) {
        ...
        case LOAD_USER_SHIPPING_INFO_REQUEST:
            return {
                loading: true
            }

        case LOAD_USER_SHIPPING_INFO_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case LOAD_USER_SHIPPING_INFO_FAIL:
            return {
                loading: false,
                shippingInfo: null,
                error: action.payload
...
export const updateShippingInfoReducer = (state = {}, action) => {
    switch (action.type) {
