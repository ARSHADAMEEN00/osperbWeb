import {
    ...
    MATCHING_PRODUCT_DETAILS_REQUEST,
    MATCHING_PRODUCT_DETAILS_SUCCESS,
    MATCHING_PRODUCT_DETAILS_FAIL,
    NEW_REVIEW_REQUEST,
    NEW_REVIEW_SUCCESS,
    NEW_REVIEW_RESET,
    NEW_REVIEW_FAIL,
    ...
    switch (action.type) {
        ...
        case CATEGORY_PRODUCTS_SUCCESS:
            return {
                ...
                categoryProductsCount: action.payload.categoryProductsCount,
            }
...
export const productDetailsReducer = (state = { product: {}, matchingProduct: {} }, action) => {
    switch (action.type) {
        ...
        case PRODUCT_DETAILS_SUCCESS:
            return {
                loading: false,
                product: action.payload.product,
                matchingProduct: action.payload.matchingProduct
            }
...
// Matching Product Details Reducer
export const matchingProductDetailsReducer = (state = { product: {} }, action) => {
    switch (action.type) {

        case MATCHING_PRODUCT_DETAILS_REQUEST:
            return {
                ...state,
                loading: true
            }

        case MATCHING_PRODUCT_DETAILS_SUCCESS:
            return {
                loading: false,
                product: action.payload.product,
                matchingProduct: action.payload.matchingProduct
        ...
        case MATCHING_PRODUCT_DETAILS_FAIL:
            return {
                ...state,
                error: action.payload
            }
