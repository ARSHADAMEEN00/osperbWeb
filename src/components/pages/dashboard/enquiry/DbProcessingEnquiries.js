...
const DbProcessingEnquiries = ({ history }) => {
    ...
    const setEnquiries = () => {
        ...
        enquiries.forEach(enquiry => {
            ...
            if(enquiry.enquiryStatus === "Processing"){      
                data.rows.push({
                    name: enquiry.name,
                    email: enquiry.email,
                    place: enquiry.place,
...
export default DbProcessingEnquiries
