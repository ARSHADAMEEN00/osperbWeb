        ...
        enquiries.forEach(enquiry => {
            data.rows.push({
                ...
                enquiryStatus: 
                  ...
                  enquiry.enquiryStatus && String(enquiry.enquiryStatus).includes('New')
                  ? <p style={{ color: 'blue' }}>{enquiry.enquiryStatus}</p>
                  : enquiry.enquiryStatus && String(enquiry.enquiryStatus).includes('Processing') ?
                    <p style={{ color: 'Orange' }}>{enquiry.enquiryStatus}</p> 
                  : enquiry.enquiryStatus && String(enquiry.enquiryStatus).includes('Converted') ?
                    <p style={{ color: 'Green' }}>{enquiry.enquiryStatus}</p> 
                  : <p style={{ color: 'Red' }}>{enquiry.enquiryStatus}</p>,
    ...
    return (
      ...
      <div className="db__home">
        <div className="db__sidebar_wrap">
          <DbSidebar enquiries allEnquiry/>
        </div>
