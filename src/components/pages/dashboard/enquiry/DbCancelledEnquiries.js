...
const DbCancelledEnquiries = ({ history }) => {
    ...
    const setEnquiries = () => {
        ...
        enquiries.forEach(enquiry => {
            ...
            if(enquiry.enquiryStatus === "Cancelled"){      
                data.rows.push({
                    name: enquiry.name,
                    email: enquiry.email,
                    place: enquiry.place,
                    ...
                    enquiry.enquiryStatus && String(enquiry.enquiryStatus).includes('Cancelled')
...
export default DbCancelledEnquiries
